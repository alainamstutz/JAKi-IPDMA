...
(1)R Packages: abind arm asypow bayesm bayesSurv BBmisc bitops bspmma Cairo cairoDevice car caret chron clinfun coda coin colorspace copas data.table dichromat digest doBy doParallel e1071 ellipse epicalc fields foreach fork Formula gam GAMBoost ggplot2 gridBase gridExtra gsl gtable HH Hmisc HTMLUtils hwriter hwriterPlus iterators kernlab labeling latticeExtra leaps lme4 lubridate mcmc MCMCpack memoise meta metacor metafor metagen metaLik metamisc MSToolkit muhaz multcomp munsell mvmeta mvtnorm outliers pcaPP plotrix plyr proto R2HTML R2WinBUGS randomForest RColorBrewer reshape2 RGraphics rmeta robust robustbase rrcov RUnit rworldmap sas7bdat scales scatterplot3d smoothSurv sp spam ssanv stringr TeachingDemos xtable survival
