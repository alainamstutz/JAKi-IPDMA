...
* Numeric or factor?
* *__Decision 01.11.23__*: Don't assume linearity (numeric), use it as a factor
...
* *__Decision 01.11.23__*: Drop this adjustment variable. Justification: consistency across trials/models; adjustment would not be by co-medication, but by trial; and collinearity in models.


## Subgroup analyses
1. Respiratory support & comedication: Numeric or factor?
2. Comorbidities: Factor
...
* mort_28 & mort_60 outcomes: 12 missing -> MICE as SENS or a different imputation technique?
* new_mv_28 & new_mvd_28: 11 missing -> MICE as SENS or a different imputation technique?
b) ACTT2: 
* sympdur & comorbities -> MICE for subgroup analysis?
* mort_28 (& mort_60): 47 missing -> MICE for SENS or a different imputation technique?
* new_mv_28 & new_mvd_28: 26 missing -> MICE for SENS or a different imputation technique?
c) Ghazaeian: No missing (besides 2 in CRP)
d) Tofacov: No missing (besides 1 in CRP)
e) Covinib: 3-5 missings in mort_28/mort_60/new_mv_28/new_mvd_28 -> MICE for SENS or a different imputation technique?
