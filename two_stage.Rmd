...
# (i) Primary outcome: Mortality at day 28 // add the non-IPD RCTs
```{r warning=FALSE, fig.width=13, fig.height=4}
...
addmargins(table(df_prevent$mort_28, df_prevent$trt, useNA = "always"))[4,2]
...
# Add the new row to your existing dataframe
df_mort28_agg <- bind_rows(df_mort28, row_prevent)
