...
# Load Data
```{r, include=FALSE}
df <- read_xlsx("/Users/amstutzal/Library/CloudStorage/OneDrive-usb.ch/Dokumente - JAKi IPDMA data source management/General/PANCOVID/JAKi_IPDMA_codebook_pancovid v3.xlsx", sheet = "data")
df_clinstatus <- read_xlsx("/Users/amstutzal/Library/CloudStorage/OneDrive-usb.ch/Dokumente - JAKi IPDMA data source management/General/PANCOVID/JAKi_IPDMA_codebook_pancovid v3.xlsx", sheet = "clinical status")
df_ae <- read_xlsx("/Users/amstutzal/Library/CloudStorage/OneDrive-usb.ch/Dokumente - JAKi IPDMA data source management/General/PANCOVID/JAKi_IPDMA_codebook_pancovid v3.xlsx", sheet = "list of AEs")
df_comorb <- read_xlsx("/Users/amstutzal/Library/CloudStorage/OneDrive-usb.ch/Dokumente - JAKi IPDMA data source management/General/PANCOVID/JAKi_IPDMA_codebook_pancovid v3.xlsx", sheet = "comorbidites")
```
