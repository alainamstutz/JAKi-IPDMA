...
* Numeric or factor?
* *__Decision 01.11.23__*: Don't assume linearity (numeric), use it as a factor (inkl. when centering in one-stage?)
...
3. Rare event correction? See e.g. firth regression in Ghazaeian, respiratory support, all 7 events only in clinstatus_baseline == 3
...
Alternative imputation strategy (based on ACTT2 clinicalstatus day 15):
