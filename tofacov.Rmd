...
# Load Data
```{r, include=FALSE}
df <- read_xlsx("/Users/amstutzal/Library/CloudStorage/OneDrive-usb.ch/Dokumente - JAKi IPDMA data source management/General/TOFACOV/JAK inhibitor metaanalysis TOFACOV2.xlsx")
